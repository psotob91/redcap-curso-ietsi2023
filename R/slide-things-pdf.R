slide_buttons_pdf <- function(slide_id) {
  glue::glue('<p><a class="btn btn-danger" target="_blank" href="{slide_id}.pdf"><i class="fa-solid fa-arrow-up-right-from-square"></i> Ver diapositivas en una nueva ventana</a></p>')
}
